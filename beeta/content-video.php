	...
	<?php 
		if ( is_single() ) { ?>
			<div class="post-thumbnail">
				<?php echo do_shortcode(get_post_meta( $post->ID, '_beeta_post_intro', true )); ?>
		...
		<div class="post-info"> 
			...
			<?php else : ?>
				...
				<div class="entry-summary">
					<?php the_excerpt(); ?>
					<a class="readmore button" href="<?php the_permalink(); ?>"><?php if(isset($beeta_opt['readmore_text']) && $beeta_opt['readmore_text']!=''){ echo esc_html($beeta_opt['readmore_text']); } else { esc_html__('Read more', 'beeta');}  ?></a>
			...
			<?php if ( is_single() ) : ?>
				...
				<div class="author-info">
					...
					<div class="author-description">
						<h2><?php esc_html__( 'About the Author:', 'beeta'); printf( '<a href="'.esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ).'" rel="author">%s</a>' , get_the_author()); ?></h2>
