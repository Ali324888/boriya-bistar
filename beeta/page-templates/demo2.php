...
if(count($jscomposer_templates) > 0) {
	foreach($jscomposer_templates as $jscomposer_template){
		if($jscomposer_template->post_title == 'Cosmetic Header 2' || $jscomposer_template->post_title == 'Cosmetic Footer 1'){
		...
		<div class="page-wrapper">
			 	...
			 	<div class="header"> 
					<div class="header-content">
						...
						if ( isset($beeta_opt['header_layout']) && $beeta_opt['header_layout']!="") {
							...
							if(count($jscomposer_templates) > 0) {
								foreach($jscomposer_templates as $jscomposer_template){
									if($jscomposer_template->post_title == 'Cosmetic Header 2'){
			...
			<div class="footer cosmetic-footer-1">
				...
				if ( isset($beeta_opt['footer_layout']) && $beeta_opt['footer_layout']!="" ) {
					...
					if(count($jscomposer_templates) > 0) {
						foreach($jscomposer_templates as $jscomposer_template){
							if($jscomposer_template->post_title == 'Cosmetic Footer 1'){
								echo do_shortcode($jscomposer_template->post_content);
							}
						}
					}
